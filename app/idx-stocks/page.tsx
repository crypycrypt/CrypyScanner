      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <img src="/assets/ic_chart.svg" alt="" className="w-9 h-9" />
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                IDX Stocks
              </h1>
              <p className="text-slate-400 mt-2">Scanner sinyal saham IDX — data Yahoo Finance, gratis, tanpa API key</p>
            </div>
          </div>
        ...
        <StockMarketOverview market="IDX" />
        <StockSignalTerminal market="IDX" />
      </div>
    </main>
  )
}
